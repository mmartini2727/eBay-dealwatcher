...
└── mcp_server/
  ├── server.py (V1.0) streamable HTTP, LAN only — separate compose service/process, never imports dealwatch.main; three tools built in prompt 1 (get_system_health, trace_title, explain_listing), five more in prompt 2
